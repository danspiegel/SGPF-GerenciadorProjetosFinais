      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-link"></i> <span>Início</span></i>
              </a>
            </li>
            ...
            <li class="treeview active">
              <a href="#">
				<i class="fa fa-link"></i> <span>Docentes</span> <i class="fa fa-angle-left pull-right"></i>
			  </a>
              <ul class="treeview-menu">
                <li><a href="../paginas/docentes_manter.html"><i class="fa fa-circle-o"></i> Meus Dados</a></li>
