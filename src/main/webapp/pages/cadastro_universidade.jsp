					...
					<div id="id_formPrimeiraParte">	
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
									<select id="id_estadoUniversal" class="form-control" name="vo.endereco.estado.id">
						...
						<div class="form-group ">
							<a href="" type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Próximo</a>
						</div>
						
					</div>
					
					<div id="id_formSegundaParte" style="display:none;">
						...
						<div class="form-group ">
							<a href="" type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Confirmar</a>
						</div>
